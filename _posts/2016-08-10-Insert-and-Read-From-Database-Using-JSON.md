...
[In a previous article](/website/java/Generate-Customized-Code-With-Plugins) I went into detail on how to create a new plugin for Speedment, so here is the short version. Create a new maven project and set Speedment and Gson as dependencies.
